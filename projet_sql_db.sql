...
--
-- Hôte : 127.0.0.1:3306
-- Généré le : lun. 26 fév. 2024 à 12:47
...
(1011, 'Hospital Sud Farncilien', '40 Avenue Serge Dassault'),
(1012, 'Hospital Nord Essone', '09 Rue Camille Flammarion'),
(1013, 'Hospital Louise Michel', '06 Avenue de Général de Gaulle'),
(1014, 'Hospital de Juvisy', '09 Rue Camille Flammarion'),
(1015, 'Hospital Arpajon', '18 Avenue de Verdun');
...
(1, 'unilab', 'Mbappe'),
(2, 'carieland', 'JayZ'),
(3, 'Healthy', 'Christophe'),
(4, 'République', 'Alexandre'),
(5, 'saint-lazare', 'Thibault');
...
('8000', 'Juliette', 'Chirstine', '16 avenue de langoulaire', '0915326545', 2100, 50, 'Cardiology'),
('8001', 'Josephine', 'Pierre', '16 rue de la vie', '0384659566', 2500, 51, 'Cardiology'),
('8002', 'françois', 'Lemaire', '05 rue de général', '0765956532', 2100, 52, 'Cardiology'),
('8003', 'Richard', 'Ardison', '58 avenue de la mouette', '0666959177', 2500, 53, 'Denta'),
('8004', 'Mickeal', 'Jackson', '17 rue de la pop', '0645953595', 2220, 54, 'Denta'),
('8005', 'Alexandre', 'Zouaki', '95 rue de Paris', '0795653525', 2600, 55, 'Pathology'),
('8006', 'Axel', 'Tournier', '16 rue des coteaux', '0695658532', 3250, 56, 'Nephrology'),
('8007', 'Ray', 'Manta', '16 rue de la mer', '0795653214', 2500, 57, 'Nephrology'),
('8008', 'Holdel', 'Passo', '35 rue de la faritas', '0695321574', 4200, 58, 'Denta'),
('8009', 'Mickeal', 'Youn', '23 allée de la planète bleue', '0677585479', 5600, 59, 'Denta'),
('8010', 'Chloé', 'Vaisse', '20 rue de la tortue', '0645985625', 4200, 60, 'Nephrology'),
('8011', 'Jamie', 'Lester', '02 rue des rails', '0726957431', 2600, 55, 'Nephrology');
...
('0001', 'Richard', 'Pierre', '180 rue dauxonne', '0678589635', '50', '09.09.2019', '11.09.2019', 'David José'),
('0002', 'Christian', 'Dior', '26 rue de de Nervers', '0649655245', '51', '12.09.2019', '13.09.2019', 'Esteban Miguel'),
('0003', 'Ola', 'Vache', '19 rue du pré', '0744153259', '52', '14.09.2019', '16.09.2019', 'Marie Amélie'),
('0004', 'Fernadez', 'Bastien', '84 rue de la forêt', '0648953521', '53', '14.09.2019', '15.09.2019', 'Antoine Griezman'),
('0005', 'Pathé', 'Gaumont', '34 rue du cinéma', '0755953254', '54', '16.09.2019', '17.09.2019', 'Chou Fleur'),
('0006', 'Usain', 'Bolt', '74 rue du sprint', '0695324595', '55', '18.09.2019', '19.09.2019', 'Carla Malfois'),
('0007', 'Corentin', 'Damasse', '58 route de la montagne', '0645328545', '55', '19.09.2019', '21.09.2019', 'Carla Malfois'),
('0008', 'Entour', 'Loupe', '01 rue de la méfiance', '0725654785', '55', '21.09.2019', '25.09.2019', 'David José'),
('0009', 'Naruto', 'Shippuden', '74 rue du hokage', '0765321495', '53', '23.09.2019', '24.09.2019', 'David José');
...
('9001', 'Casper', 'lefantome', '17 avenue du manoir', '0614856574', 'Marie Amélie'),
('9002', 'Zinédine', 'Zidan', '17 avenue de la tête', '0795653515', 'Jean Patrice'),
('9003', 'Eter', 'Nué', '75 avenue du mouchoir', '0795321465', 'Car Glass'),
('9004', 'Lionel', 'Messi', '65 avenue du transfert', '0795753265', 'Marina Pisa'),
('9005', 'Trivial', 'Laka', '94 rue insh', '0619853698', 'Mathilde Peyres'),
('9006', 'Igoula', 'Minou', '45 rue la lampe', '0619664856', 'Colline Lemant'),
('9007', 'Bague', 'Croissis', '61 rue alouette', '0619528285', 'Luc Jean'),
('9008', 'Cristophe', 'Lemettre', '09 rue de la course', '0695650215', 'Antoine Danielle'),
('9009', 'Costa', 'Cafe', '78 rue de la tasse', '0645020695', 'Coude Pouce'),
('9010', 'Nabil', 'Fekir', '96 avenue vauban', '0695850201', 'Bras Depitt'),
('9011', 'Claude', 'François', '16 rue de la tombe', '0703059532', 'Pied Thon');
...
('1011', 'Cris', 'Taline', '35 rue de la bouteille', '0755485965', 4600, 'full-timer', 'Anaesthetics', 'République'),
('1012', 'Olivier', 'Jean', '48 rue de leau', '0654956585', 6500, 'Part-timer', 'Cardiology', 'unilab'),
('1013', 'Bryan', 'Kobe', '16 rue du panier', '0605027565', 7000, 'full-timer', 'Pathology', 'Healthy'),
('1014', 'Akuna', 'Matata', '75 rue du lyon', '0606060606', 6800, 'Part-timer', 'Denta', 'Carieland'),
('1015', 'Dimitri', 'Payet', '13 rue de Marseille', '0613626598', 6200, 'full-timer', 'Haematology', 'République'),
('1016', 'Pain', 'Demi', '75 rue de la baguette', '0785020145', 6500, 'full-timer', 'Gastroenterology', 'Saint-Lazare'),
('1017', 'Barbe', 'Cue', '03 rue du feu', '0685956574', 3000, 'part-timer', 'Anaesthetics', 'république'),
('1018', 'Mur', 'Aille', '15 rue de la chine', '0785026595', 2300, 'full-timer', 'Anaesthetics', 'saint-lazare'),
('1019', 'Cross', 'Pierre', '14 rue de la ville', '0652956585', 3600, 'part-timer', 'Pathology', 'Carieland'),
('1020', 'Guepe', 'Abeile', '24 rue de la picure', '0611223311', 5000, 'full-timer', 'Denta', 'Healthy'),
('1021', 'Leo', 'Pard', '45 rue savane', '0745026595', 4500, 'Part-timer', 'Haematology', 'République'),
('1022', 'Permanov', 'Jean', '14 rue du stream', '0645953202', 4900, 'full-timer', 'Gastroenterology', 'saint-lazare');
...
('1', 'Car', 'Four', '36 rue du market', '0603256595', 1385, 'Pipes', 'Saint-Lazare'),
('2', 'Jean', 'Claude', '74 rue mermoze', '0603548595', 1385, 'Electric', 'Unilab'),
('3', 'Van', 'Dam', '95 rue Belgique', '0685953295', 1385, 'Pipes', 'République'),
('4', 'Coca', 'Cola', '36 rue du gaz', '0765958532', 1385, 'Electric', 'Carieland'),
('5', 'Loclas', 'Edmound', '14 avenue georges', '0765953265', 1385, 'Pipes', 'Carieland'),
('6', 'Dior', 'Christian', '99 rue du luxe', '0795032569', 1385, 'Pipes', 'Unilab'),
('7', 'Chris', 'Chros', '66 rue du lac', '0695327515', 1385, 'Electric', 'Healthy'),
('8', 'Perez', 'Roberto', '18 rue de la vitesse', '0632651502', 1385, 'Pipes', 'République'),
('9', 'Alvarez', 'Condort', '16 rue manou', '0615325987', 1385, 'Electric', 'République');
COMMIT;
