...
CREATE TABLE IF NOT EXISTS `bill` (
  ...
  FOREIGN KEY (`Bill_patient_num`) REFERENCES `patient`(`Pat_no`)
...
CREATE TABLE IF NOT EXISTS `hospital` (
  `hsp_code` INT NOT NULL PRIMARY KEY,
...
CREATE TABLE IF NOT EXISTS `nurse` (
  `Nur_no` INT NOT NULL PRIMARY KEY,
...
CREATE TABLE IF NOT EXISTS `outpatient` (
  `OPat_no` INT NOT NULL PRIMARY KEY,
...
CREATE TABLE IF NOT EXISTS `researcher` (
  `Res_no` INT NOT NULL PRIMARY KEY,
...
CREATE TABLE IF NOT EXISTS `technician` (
  `Technician_no` INT NOT NULL PRIMARY KEY,
